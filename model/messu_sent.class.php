...
@include_once('messu_sent.extend.php');

class messu_sent extends generictable 
{
         var $pretty_name = 'messu_sent';
         var $pretty_plural = 'messu_sent';
         var $pageheader = '';
         var $pagefooter = '';
         private $observers;
         ...
         {
         	$this->querytablename = 'messu_sent';
         	$this->classname = 'messu_sent';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['messu_sent'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['messu_sent']);
	         return SUCCESS;
         }
