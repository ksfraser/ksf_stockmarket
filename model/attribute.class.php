...
@include_once('attribute.extend.php');

class attribute extends generictable 
{
         var $pretty_name = 'attribute';
         var $pretty_plural = 'attribute';
         var $pageheader = '';
         var $pagefooter = '';
         private $observers;
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['attribute'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['attribute']);
	         return SUCCESS;
         }
