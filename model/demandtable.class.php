...
@include_once('demandtable.extend.php');

class demandtable extends generictable 
{
         var $pretty_name = '';
         var $pretty_plural = '';
         var $pageheader = '';
         ...
         {
         	$this->querytablename = 'demandtable';
         	$this->classname = 'demandtable';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['demandtable'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['demandtable']);
	         return SUCCESS;
         }
