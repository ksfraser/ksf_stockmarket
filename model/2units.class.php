...
@include_once('2units.extend.php');

class 2units extends generictable 
{
         var $pretty_name = '';
         var $pretty_plural = '';
         var $pageheader = '';
         ...
         {
         	$this->querytablename = '2units';
         	$this->classname = '2units';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['2units'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['2units']);
	         return SUCCESS;
         }
