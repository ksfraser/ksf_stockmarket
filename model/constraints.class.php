...
@include_once('constraints.extend.php');

class constraints extends generictable 
{
         var $pretty_name = '';
         var $pretty_plural = '';
         var $pageheader = '';
         ...
         {
         	$this->querytablename = 'constraints';
         	$this->classname = 'constraints';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['constraints'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['constraints']);
	         return SUCCESS;
         }
