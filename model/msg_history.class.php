...
@include_once('msg_history.extend.php');

class msg_history extends generictable 
{
         var $pretty_name = 'msg_history';
         var $pretty_plural = 'msg_history';
         var $pageheader = '';
         var $pagefooter = '';
         private $observers;
         ...
         {
         	$this->querytablename = 'msg_history';
         	$this->classname = 'msg_history';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['msg_history'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['msg_history']);
	         return SUCCESS;
         }
