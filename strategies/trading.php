...
/*
There is a common theme on different sites about strategies:
...
Your trade entry rules should address each of the following:
...
Simply follow the link to your selected market.
   ...
   1. Stocks – www.ultimate-trading-systems.com/stocks
   2. Options – www.ultimate-trading-systems.com/options
   3. Futures/commodities – www.ultimate-trading-systems.com/futures
   4. Forex – www.ultimate-trading-systems.com/forex
...
Actions
   ...
   1. If you have decided to develop your own system from scratch, plan your entry criteria making sure to do an appropriate amount of back testing – documenting everything.
   2. If you’re looking for a ready-made entry system to get you started, get yourself the system that corresponds to the market you have decided to trade in:
...
This decision needs to be based on your overall trading goals, while recognising your other financial commitments outside of trading. This was discussed in chapter 3.
Maximum loss

Determine the maximum amount of capital you are prepared to lose in one trade.

Like the professional poker player I met, you might set your limit at 2%. In Market Wizard Larry Hite recommends not going beyond 1%. Other professional traders say 0.25%.  You need to find the sweet spot to match your trading float.
Initial stops
...
Note: Risk and Money management rules should include:
   ...
   1. defining your trading float
   2. setting a maximum loss
...
Action
   ...
   1. Using both Trading Secrets Revealed and the package containing your entry signals, your next task is to document your trailing stop rules.


Drawdown Stop
If the price drops X percent (ie 10%) from the recent high since purchase, sell.
