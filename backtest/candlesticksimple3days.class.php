...
class candlesticksimple3days extends backtest
{
	...
	function SellStrategy()
	{
		...
		if( $count > 0 )
		{
			...
			if( $average > $this->Getbuystockaverage() )
				if( strcmp( $this->Getlastaction(), "buystock2" ) == 0 )
					$this->Setaction( "buystock1" );
				else
				if( strcmp( $this->Getlastaction(), "buystock1" ) == 0 )
					$this->Setaction( "buystock" );
				else
					$this->Setaction( "buystock2" );
			else
			if( $average < $this->Getsellstockaverage() )
				if( strcmp( $this->Getlastaction(), "sellstock1" ) == 0 )
					$this->Setaction( "sellstock" );
				else
				if( strcmp( $this->Getlastaction(), "sellstock2" ) == 0 )
					$this->Setaction( "sellstoc1" );
				else
					$this->Setaction( "sellstock2" );
			else
				$this->Setaction( "None" );
		}
	}
