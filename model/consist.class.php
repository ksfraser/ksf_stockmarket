...
@include_once('consist.extend.php');

class consist extends generictable 
{
         var $pretty_name = '';
         var $pretty_plural = '';
         var $pageheader = '';
         ...
         {
         	$this->querytablename = 'consist';
         	$this->classname = 'consist';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['consist'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['consist']);
	         return SUCCESS;
         }
