...
@include_once('groups.extend.php');

class groups extends generictable 
{
         var $pretty_name = 'groups';
         var $pretty_plural = 'groups';
         var $pageheader = '';
         var $pagefooter = '';
         private $observers;
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['groups'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['groups']);
	         return SUCCESS;
         }
