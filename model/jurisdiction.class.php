...
@include_once('jurisdiction.extend.php');

class jurisdiction extends generictable 
{
         var $pretty_name = '';
         var $pretty_plural = '';
         var $pageheader = '';
         ...
         {
         	$this->querytablename = 'jurisdiction';
         	$this->classname = 'jurisdiction';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['jurisdiction'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['jurisdiction']);
	         return SUCCESS;
         }
