...
|-
|| ADX (Average Directional Index) drops below 20 (range-bound) || Shift tactical → Bollinger MR
|-
|| VIX (Volatility Index) exceeds 30 (fear) || Buy tactical opportunities / hedge
|}
...
{| class="wikitable"
! VIX (Volatility Index) Level || Regime || Strategy Emphasis
|-
