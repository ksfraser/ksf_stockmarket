...
function testcandlesticksimple2daytenth( $symbol, $startingcash, $tradedatearray, $actionarray )
{
	...
	$user = "candlestick_simple2daytenth";
	//Open a log file
	...
	if( require_once( 'adduser.php' ))
	{
		$ret = adduser( $flog,
				...
				$firstname = "Buy Sell one tenth of all stock or cash",
