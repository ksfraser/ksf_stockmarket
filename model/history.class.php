...
@include_once('history.extend.php');

class history extends generictable 
{
         var $pretty_name = '';
         var $pretty_plural = '';
         var $pageheader = '';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['history'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['history']);
	         return SUCCESS;
         }
