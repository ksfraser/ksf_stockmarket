<div class="card" style="margin-top:12px;">
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:12px;">
        <div>
            ...
            <div style="height:180px;"><canvas id="rsiChart" style="display:block; width:100%; height:100%;"></canvas></div>
        </div>
        <div>
            ...
            <div style="height:180px;"><canvas id="macdChart" style="display:block; width:100%; height:100%;"></canvas></div>
        </div>
        <div>
            ...
            <div style="height:180px;"><canvas id="stochChart" style="display:block; width:100%; height:100%;"></canvas></div>
        </div>
    </div>
</div>
