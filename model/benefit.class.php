...
@include_once('benefit.extend.php');

class benefit extends generictable 
{
         var $pretty_name = 'benefit';
         var $pretty_plural = 'benefit';
         var $pageheader = '';
         var $pagefooter = '';
         private $observers;
         ...
         {
         	$this->querytablename = 'benefit';
         	$this->classname = 'benefit';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['benefit'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['benefit']);
	         return SUCCESS;
         }
