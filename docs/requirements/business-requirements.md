...
### BR-6: External Strategy Research
**Statement**: The system shall autonomously scan external data sources for new strategy ideas and integrate them into the backtesting pipeline.
**Rationale**: Manual strategy discovery is slow and biased. Automated scanning of Reddit, arXiv, and TradingView surfaces novel ideas from the quant community.
**Priority**: Should Have
**Acceptance Criteria**:
- [ ] Research agent runs nightly (02:00) to generate internal briefs from existing system data
- [ ] Research agent scans external sources (Reddit, arXiv) and scores ideas on novelty/feasibility/edge
