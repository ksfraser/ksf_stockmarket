...
@include_once('measurements.extend.php');

class measurements extends generictable 
{
         var $pretty_name = '';
         var $pretty_plural = '';
         var $pageheader = '';
         ...
         {
         	$this->querytablename = 'measurements';
         	$this->classname = 'measurements';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['measurements'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['measurements']);
	         return SUCCESS;
         }
