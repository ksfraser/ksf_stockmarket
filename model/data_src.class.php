...
@include_once('data_src.extend.php');

class data_src extends generictable 
{
         var $pretty_name = 'data_src';
         var $pretty_plural = 'data_src';
         var $pageheader = '';
         var $pagefooter = '';
         private $observers;
         ...
         {
         	$this->querytablename = 'data_src';
         	$this->classname = 'data_src';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['data_src'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['data_src']);
	         return SUCCESS;
         }
