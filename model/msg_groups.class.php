...
@include_once('msg_groups.extend.php');

class msg_groups extends generictable 
{
         var $pretty_name = 'msg_groups';
         var $pretty_plural = 'msg_groups';
         var $pageheader = '';
         var $pagefooter = '';
         private $observers;
         ...
         {
         	$this->querytablename = 'msg_groups';
         	$this->classname = 'msg_groups';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['msg_groups'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['msg_groups']);
	         return SUCCESS;
         }
