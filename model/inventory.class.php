...
@include_once('inventory.extend.php');

class inventory extends generictable 
{
         var $pretty_name = '';
         var $pretty_plural = '';
         var $pageheader = '';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['inventory'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['inventory']);
	         return SUCCESS;
         }
