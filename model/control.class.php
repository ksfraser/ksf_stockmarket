...
@include_once('control.extend.php');

class control extends generictable 
{
         var $pretty_name = 'control';
         var $pretty_plural = 'control';
         var $pageheader = '';
         var $pagefooter = '';
         private $observers;
		...
		$this->defaultsort = '';
         ...
         function Pop()
         {
	       ...
	       //  $this = unserialize($_SESSION['control']);
	         return SUCCESS;
         }
