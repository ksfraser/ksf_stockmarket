...
@include_once('coord_t.extend.php');

class coord_t extends generictable 
{
         var $pretty_name = 'coord_t';
         var $pretty_plural = 'coord_t';
         var $pageheader = '';
         var $pagefooter = '';
         private $observers;
         ...
         {
         	$this->querytablename = 'coord_t';
         	$this->classname = 'coord_t';
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['coord_t'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['coord_t']);
	         return SUCCESS;
         }
