...
# According to data from the Finance::YahooQuote perl module, yahoo has the following:
...
SERVERURL=http://ca.finance.yahoo.com
STOCKS=CP+BNI+CN+PDM.TO+PDM-UN+PDM.UN
FORMAT=snl1d1t1c1p2pomwverdybaxq
FORMAT=snll1t1d1cc1p2va2ibapomghwjkerr1qdyj1s1p1n4c3v1w1g1g4d2g3l2l3
FORMAT=r1qder
