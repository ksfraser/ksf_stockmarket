...
@include_once('actor.extend.php');

class actor extends generictable 
{
         var $pretty_name = 'actor';
         var $pretty_plural = 'actor';
         var $pageheader = '';
         var $pagefooter = '';
         private $observers;
		...
		$this->defaultsort = '';
         ...
         function Push()
         {
	         $_SESSION['actor'] = serialize($this);
	         return SUCCESS;
         }
         function Pop()
         {
                 //Can't do this in self - this is how to do it outside
	       //  $this = unserialize($_SESSION['actor']);
	         return SUCCESS;
         }
