-- stock_dcf_valuations.sql
-- Standalone schema for the DCF valuation output table.
-- Run: mysql -u <user> -p <database> < sql/stock_dcf_valuations.sql
USE `ksf_stockmarket`;
...
CREATE TABLE IF NOT EXISTS stock_dcf_valuations (
    ...
    -- Computed outputs (mirrors valuation_dcf.php CSV)
